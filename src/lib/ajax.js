...
export function request(
   ...
   *  require special headers from the remote side. That policy is called “CORS”: Cross-Origin Resource Sharing
   *
   *  XMLHttpRequest can make cross-domain requests, using the same CORS policy as fetch.
   *  Just like fetch, it does not send cookies and HTTP-authorization to another origin by default. To enable them,
   *  set xhr.withCredentials to true
   */
